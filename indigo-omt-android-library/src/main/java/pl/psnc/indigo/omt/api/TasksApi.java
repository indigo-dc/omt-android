...
public class TasksApi extends Api {
    ...
    private final String mEndpoint = "tasks";
    public static final MediaType MEDIA_TYPE_INDIGO = MediaType.parse("application/json");
    ...
    public void getTasks(HashMap params, TasksCallback callback) {
        ...
        ((TasksApiThread) mWorker).callApi(mHttpAddress, mEndpoint, params);
    }
    ...
    public void getTask(int taskId, TaskDetailsCallback callback) {
        ...
        ((TaskDetailsApiThread) mWorker).callApi(mHttpAddress, mEndpoint, taskId);
    }
    ...
    public void createTask(Task newTask, TaskCreationCallback callback) {
        ...
        ((TaskCreateApiThread) mWorker).callApi(mHttpAddress, mEndpoint, newTask);
    }
}

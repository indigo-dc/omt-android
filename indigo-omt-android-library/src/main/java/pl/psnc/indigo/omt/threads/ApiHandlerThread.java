...
public abstract class ApiHandlerThread extends HandlerThread {
    ...
    protected String apiFullAddress;
    ...
    protected void createFullAddress(String baseUrl, String endpoint, Map<String, String> parameters) {
        try {
            apiFullAddress = RootApi.getRootForAddress(baseUrl).getURLAsString() + endpoint;
    ...
    protected void createFullAddress(String baseUrl, String endpoint, int itemId) {
        try {
            apiFullAddress = RootApi.getRootForAddress(baseUrl).getURLAsString() + endpoint + "/" + itemId;
        } catch (WrongApiUrlException e) {
            mCallback.onError(e);
            quit();
            return;
